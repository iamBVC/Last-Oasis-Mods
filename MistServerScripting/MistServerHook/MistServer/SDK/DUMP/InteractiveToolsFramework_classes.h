...
struct UGizmoBaseComponent : UPrimitiveComponent {
	struct FLinearColor Color; // 0x7b8(0x10)
	float HoverSizeMultiplier; // 0x7c8(0x04)
	float PixelHitDistanceThreshold; // 0x7cc(0x04)
	char pad_7D8[0x8]; // 0x7d8(0x08)

	void UpdateWorldLocalState(bool bWorldIn); // Function InteractiveToolsFramework.GizmoBaseComponent.UpdateWorldLocalState // (Final|Native|Public) // @ game+0x2f3e4c0
	void UpdateHoverState(bool bHoveringIn); // Function InteractiveToolsFramework.GizmoBaseComponent.UpdateHoverState // (Final|Native|Public) // @ game+0x2f3e430
};

// Class InteractiveToolsFramework.GizmoArrowComponent
// Size: 0x800 (Inherited: 0x7e0)
struct UGizmoArrowComponent : UGizmoBaseComponent {
	struct FVector Direction; // 0x7d8(0x0c)
	float Gap; // 0x7e4(0x04)
	float Length; // 0x7e8(0x04)
	float Thickness; // 0x7ec(0x04)
...
struct UGizmoBoxComponent : UGizmoBaseComponent {
	struct FVector Origin; // 0x7d8(0x0c)
	char pad_7EC[0x4]; // 0x7ec(0x04)
	struct FQuat Rotation; // 0x7f0(0x10)
	struct FVector Dimensions; // 0x800(0x0c)
	float LineThickness; // 0x80c(0x04)
	bool bRemoveHiddenLines; // 0x810(0x01)
	bool bEnableAxisFlip; // 0x811(0x01)
	char pad_812[0xe]; // 0x812(0x0e)
};

// Class InteractiveToolsFramework.GizmoCircleComponent
// Size: 0x800 (Inherited: 0x7e0)
struct UGizmoCircleComponent : UGizmoBaseComponent {
	struct FVector Normal; // 0x7d8(0x0c)
	float Radius; // 0x7e4(0x04)
	float Thickness; // 0x7e8(0x04)
	int32_t NumSides; // 0x7ec(0x04)
	bool bViewAligned; // 0x7f0(0x01)
	bool bOnlyAllowFrontFacingHits; // 0x7f1(0x01)
...
struct UGizmoTransformSource : UInterface {
	...
	void SetTransform(struct FTransform& NewTransform); // Function InteractiveToolsFramework.GizmoTransformSource.SetTransform // (Native|Public|HasOutParms|HasDefaults) // @ game+0x2f3e2c0
	struct FTransform GetTransform(); // Function InteractiveToolsFramework.GizmoTransformSource.GetTransform // (Native|Public|HasDefaults|Const) // @ game+0x2f3e110
};
...
struct UGizmoAxisSource : UInterface {
	...
	bool HasTangentVectors(); // Function InteractiveToolsFramework.GizmoAxisSource.HasTangentVectors // (Native|Public|Const) // @ game+0x2f3e180
	void GetTangentVectors(struct FVector& TangentXOut, struct FVector& TangentYOut); // Function InteractiveToolsFramework.GizmoAxisSource.GetTangentVectors // (Native|Public|HasOutParms|HasDefaults|Const) // @ game+0x2f3e020
	struct FVector GetOrigin(); // Function InteractiveToolsFramework.GizmoAxisSource.GetOrigin // (Native|Public|HasDefaults|Const) // @ game+0x2f3df70
	struct FVector GetDirection(); // Function InteractiveToolsFramework.GizmoAxisSource.GetDirection // (Native|Public|HasDefaults|Const) // @ game+0x2f3df30
};
...
struct UGizmoClickTarget : UInterface {
	...
	void UpdateHoverState(bool bHovering); // Function InteractiveToolsFramework.GizmoClickTarget.UpdateHoverState // (Native|Public|Const) // @ game+0x2f3e3a0
};
...
struct UGizmoStateTarget : UInterface {
	...
	void EndUpdate(); // Function InteractiveToolsFramework.GizmoStateTarget.EndUpdate // (Native|Public) // @ game+0x2f3ded0
	void BeginUpdate(); // Function InteractiveToolsFramework.GizmoStateTarget.BeginUpdate // (Native|Public) // @ game+0x2f3def0
};
...
struct UGizmoFloatParameterSource : UInterface {
	...
	void SetParameter(float NewValue); // Function InteractiveToolsFramework.GizmoFloatParameterSource.SetParameter // (Native|Public) // @ game+0x2f3e1b0
	float GetParameter(); // Function InteractiveToolsFramework.GizmoFloatParameterSource.GetParameter // (Native|Public|Const) // @ game+0x2f3dfb0
	void EndModify(); // Function InteractiveToolsFramework.GizmoFloatParameterSource.EndModify // (Native|Public) // @ game+0x2f3df10
	void BeginModify(); // Function InteractiveToolsFramework.GizmoFloatParameterSource.BeginModify // (Native|Public) // @ game+0x2f3ded0
};
...
struct UGizmoVec2ParameterSource : UInterface {
	...
	void SetParameter(struct FVector2D& NewValue); // Function InteractiveToolsFramework.GizmoVec2ParameterSource.SetParameter // (Native|Public|HasOutParms|HasDefaults) // @ game+0x2f3e230
	struct FVector2D GetParameter(); // Function InteractiveToolsFramework.GizmoVec2ParameterSource.GetParameter // (Native|Public|HasDefaults|Const) // @ game+0x2f3dfe0
	void EndModify(); // Function InteractiveToolsFramework.GizmoVec2ParameterSource.EndModify // (Native|Public) // @ game+0x2f3df10
	void BeginModify(); // Function InteractiveToolsFramework.GizmoVec2ParameterSource.BeginModify // (Native|Public) // @ game+0x2f3ded0
};
...
struct UGizmoLineHandleComponent : UGizmoBaseComponent {
	struct FVector Normal; // 0x7d8(0x0c)
	float HandleSize; // 0x7e4(0x04)
	float Thickness; // 0x7e8(0x04)
	struct FVector Direction; // 0x7ec(0x0c)
	float Length; // 0x7f8(0x04)
	bool bImageScale; // 0x7fc(0x01)
};

// Class InteractiveToolsFramework.GizmoRectangleComponent
// Size: 0x810 (Inherited: 0x7e0)
struct UGizmoRectangleComponent : UGizmoBaseComponent {
	struct FVector DirectionX; // 0x7d8(0x0c)
	struct FVector DirectionY; // 0x7e4(0x0c)
	float OffsetX; // 0x7f0(0x04)
	float OffsetY; // 0x7f4(0x04)
	float LengthX; // 0x7f8(0x04)
	float LengthY; // 0x7fc(0x04)
	float Thickness; // 0x800(0x04)
	char SegmentFlags; // 0x804(0x01)
...
struct AIntervalGizmoActor : AGizmoActor {
	struct UGizmoLineHandleComponent* UpIntervalComponent; // 0x3c0(0x08)
	struct UGizmoLineHandleComponent* DownIntervalComponent; // 0x3c8(0x08)
	struct UGizmoLineHandleComponent* ForwardIntervalComponent; // 0x3d0(0x08)
};
...
struct ATransformGizmoActor : AGizmoActor {
	struct UPrimitiveComponent* TranslateX; // 0x3c0(0x08)
	struct UPrimitiveComponent* TranslateY; // 0x3c8(0x08)
	struct UPrimitiveComponent* TranslateZ; // 0x3d0(0x08)
	struct UPrimitiveComponent* TranslateYZ; // 0x3d8(0x08)
	struct UPrimitiveComponent* TranslateXZ; // 0x3e0(0x08)
	struct UPrimitiveComponent* TranslateXY; // 0x3e8(0x08)
	struct UPrimitiveComponent* RotateX; // 0x3f0(0x08)
	struct UPrimitiveComponent* RotateY; // 0x3f8(0x08)
	struct UPrimitiveComponent* RotateZ; // 0x400(0x08)
	struct UPrimitiveComponent* UniformScale; // 0x408(0x08)
	struct UPrimitiveComponent* AxisScaleX; // 0x410(0x08)
	struct UPrimitiveComponent* AxisScaleY; // 0x418(0x08)
	struct UPrimitiveComponent* AxisScaleZ; // 0x420(0x08)
	struct UPrimitiveComponent* PlaneScaleYZ; // 0x428(0x08)
	struct UPrimitiveComponent* PlaneScaleXZ; // 0x430(0x08)
	struct UPrimitiveComponent* PlaneScaleXY; // 0x438(0x08)
};
