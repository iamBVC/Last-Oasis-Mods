...
struct ADatasmithAreaLightActor : AActor {
	enum class EDatasmithAreaLightActorType LightType; // 0x3c0(0x01)
	enum class EDatasmithAreaLightActorShape LightShape; // 0x3c1(0x01)
	char pad_3C2[0x2]; // 0x3c2(0x02)
	struct FVector2D Dimensions; // 0x3c4(0x08)
	float Intensity; // 0x3cc(0x04)
	enum class ELightUnits IntensityUnits; // 0x3d0(0x01)
	char pad_3D1[0x3]; // 0x3d1(0x03)
	struct FLinearColor Color; // 0x3d4(0x10)
	float Temperature; // 0x3e4(0x04)
	struct UTextureLightProfile* IESTexture; // 0x3e8(0x08)
	bool bUseIESBrightness; // 0x3f0(0x01)
	char pad_3F1[0x3]; // 0x3f1(0x03)
	float IESBrightnessScale; // 0x3f4(0x04)
	struct FRotator Rotation; // 0x3f8(0x0c)
	float SourceRadius; // 0x404(0x04)
	float SourceLength; // 0x408(0x04)
	float AttenuationRadius; // 0x40c(0x04)
	float SpotlightInnerAngle; // 0x410(0x04)
	float SpotlightOuterAngle; // 0x414(0x04)
};
...
struct UDatasmithContentBlueprintLibrary : UBlueprintFunctionLibrary {
	...
	struct FString GetDatasmithUserDataValueForKey(struct UObject* Object, struct FName Key); // Function DatasmithContent.DatasmithContentBlueprintLibrary.GetDatasmithUserDataValueForKey // (Final|Native|Static|Public|BlueprintCallable) // @ game+0x9b3cb0
	void GetDatasmithUserDataKeysAndValuesForValue(struct UObject* Object, struct FString StringToMatch, struct TArray<struct FName>& OutKeys, struct TArray<struct FString>& OutValues); // Function DatasmithContent.DatasmithContentBlueprintLibrary.GetDatasmithUserDataKeysAndValuesForValue // (Final|Native|Static|Public|HasOutParms|BlueprintCallable) // @ game+0x9b3b00
	struct UDatasmithAssetUserData* GetDatasmithUserData(struct UObject* Object); // Function DatasmithContent.DatasmithContentBlueprintLibrary.GetDatasmithUserData // (Final|Native|Static|Public|BlueprintCallable) // @ game+0x9b3a80
};
...
struct ADatasmithImportedSequencesActor : AActor {
	struct TArray<struct ULevelSequence*> ImportedSequences; // 0x3c0(0x10)

	void PlayLevelSequence(struct ULevelSequence* SequenceToPlay); // Function DatasmithContent.DatasmithImportedSequencesActor.PlayLevelSequence // (Final|Native|Public|BlueprintCallable) // @ game+0x9b3db0
};
...
struct ADatasmithSceneActor : AActor {
	struct UDatasmithScene* Scene; // 0x3c0(0x08)
	struct TMap<struct FName, struct TSoftObjectPtr<AActor>> RelatedActors; // 0x3c8(0x50)
};
