...
struct FLandscapeEditToolRenderData {
	...
	bool DebugChannelREditorOnly; // 0x18(0x01)
	char pad_19[0x3]; // 0x19(0x03)
	int32_t DebugChannelG; // 0x1c(0x04)
	bool DebugChannelGEditorOnly; // 0x20(0x01)
	char pad_21[0x3]; // 0x21(0x03)
	int32_t DebugChannelB; // 0x24(0x04)
	bool DebugChannelBEditorOnly; // 0x28(0x01)
	char pad_29[0x7]; // 0x29(0x07)
	struct UTexture2D* DataTexture; // 0x30(0x08)
	struct UTexture2D* LayerContributionTexture; // 0x38(0x08)
	struct UTexture2D* DirtyTexture; // 0x40(0x08)
};
