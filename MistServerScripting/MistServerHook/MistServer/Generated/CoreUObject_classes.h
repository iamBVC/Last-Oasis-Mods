...
typedef void IBlendableInterface;
typedef void IMistEquipmentItemComponent;
typedef void ICurveSourceInterface;
typedef void IMistBotControllableInterface;
typedef void IMistExoskeletonWeaponControlInterface;
typedef void IMovieSceneEasingFunction;
typedef void ISlateTextureAtlasInterface;
typedef void IUserListEntry;
typedef void IUserObjectListEntry;
typedef void IInterface;
typedef void FField;
typedef void IGameplayTaskOwnerInterface;
typedef void IGameplayTagAssetInterface;
typedef void IMistHUDCrosshairInterface;
typedef void IMistWalkerModule;
typedef void IMovieScenePlaybackClient;



template<typename T, typename R>
struct TMap {
//	char unknown_data[0x50];
	void* Data;
	uint32 Count;
	uint32 unknown_data2;
	char* unknown_data3;
	char* unknown_data4;
	char* unknown_data5;
	uint32 unknown_data6;
	uint32 unknown_data7;
	uint32 unknown_data8;
	uint32 unknown_data9;
	char* unknown_data10;
	char* unknown_data11;
	char* unknown_data12;
};
...
public:
	typedef TSortableMapBase<KeyType, ValueType> Super;
...
struct TSoftClassPtr {
	char unknown_data[0x28];
};

struct LazyObjectProperty {
	char unknown_data[0x1c];
};
